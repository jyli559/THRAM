...
./build/cgra-compiler SPDLOG_LEVEL=off \
	...
	-d "../../benchmarks/test/arf/arf.json ../../benchmarks/test/centro-fir/centro-fir.json ../../benchmarks/test/cosine1/cosine1.json ../../benchmarks/test/cosine2/cosine2.json ../../benchmarks/test/ewf/ewf.json ../../benchmarks/test/fft/fft.json ../../benchmarks/test/fir/fir.json ../../benchmarks/test/fir1/fir1.json ../../benchmarks/test/resnet1/resnet1.json ../../benchmarks/test/resnet2/resnet2.json ../../benchmarks/test/stencil3d/stencil3d.json" 
	#-d "../benchmarks/test2/simple/simple.json"
	...
	#-a "../../cgra-mg/src/main/resources/cgra_adg_dfga.json" \